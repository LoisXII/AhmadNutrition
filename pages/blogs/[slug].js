...
const BlogPage = () => {
    ...
    // for scroll down to commnet form
                        ...
                        <div className="blogslugpagecont">
                            <div className="leftsitedetails">
                                ...
                                <div className="blogslugcomments" ref={replyFormRef}>
                                    {newComment.parentName && (
                                        <h2>Leave a reply to <span className="perentname">{newComment.parentName} </span> <button type="button" className="removereplybtn" onClick={handleRemoveReply}>Remove Reply</button></h2>
                                    )}
                                    {!newComment.parentName && (
                                        <h2>Leave a Reply</h2>
                                    )}
                            ...
                            <div className="rightsitedetails">
                                ...
                                <div className="rightslugcategory">
                                    <h2>CATEGORIES</h2>
                                    <ul>
                                        <Link href='/blogs/category/Next Js'><li>Healthy Eating <span>({allwork.filter(ab => ab.blogcategory[0] === "Next Js").length})</span></li></Link>
                                        <Link href='/blogs/category/Digital Marketing'><li>Nutritional Advice <span>({allwork.filter(ab => ab.blogcategory[0] === "Digital Marketing").length})</span></li></Link>
                                        <Link href='/blogs/category/React js'><li>Food Recipes<span>({allwork.filter(ab => ab.blogcategory[0] === "React js").length})</span></li></Link>
                                        <Link href='/blogs/category/Node js'><li>Weight Management <span>({allwork.filter(ab => ab.blogcategory[0] === "Node js").length})</span></li></Link>
                                        <Link href='/blogs/category/React js'><li>Sports Nutrition <span>({allwork.filter(ab => ab.blogcategory[0] === "React js").length})</span></li></Link>
                                        <Link href='/blogs/category/Flutter Dev'><li>Vegan Diets <span>({allwork.filter(ab => ab.blogcategory[0] === "Flutter Dev").length})</span></li></Link>
                                    </ul>
                                </div>
                                <div className="rightrecentpost">
                                    ...
                                    {allwork.slice(0, 3).map((blog) => {
                                        return <Link key={blog._id} href={`/blogs/${blog.slug}`} className="rightrecentp">
                                            ...
                                            <div>
                                                <h3>{blog.title}</h3>
                                                <h4 className="mt-1">{blog.tags.map((cat) => {
                                                    return <span key={cat}>{cat}</span>
                                                })}</h4>
                                            </div>
                                        </Link>
