...
export default function contact() {
    ...
    async function createProduct(ev) {
        ...
        try {
            ...
            setMessageok('✅️ Message sent successfully');
            ...
            <div className="container">
                <div className="contactformp">
                    <div className="leftcontp">
                        <h2>Get in touch</h2>
                        <h2>Let's talk about your health and wellness</h2>
                        <p>Looking to improve your diet, manage your weight, or enhance your overall well-being? Let’s work together!</p>
                        <p>Use the form on this page or reach out through other means.</p>
                        <p>I welcome your questions and feedback—I'm always here to help! <br /> Here are some ways to contact me.</p>
                        <div className="leftsociinfo">
                            <ul>
                                <li><FaPhoneVolume /> <span>Phone: <a href="tel:+962797514547" rel="nofollow" target="_blank">+962-797514547</a></span></li>
                                <li><MdAttachEmail /> <span>Email: <a href="mailto:alarajnutrition@gmail.com" rel="nofollow" target="_blank">alarajnutrition@gmail.com</a></span></li>
                                <li><GrLinkedin /> <span>Linkedin: <a href="/" rel="nofollow" target="_blank">Ahmad Al-Araj</a></span></li>
                                <li><FaTwitter /> <span>Twitter: <a href="/" rel="nofollow" target="_blank">@AhmadAlaraj</a></span></li>
                            </ul>
                        </div>
                    </div>
                    <div className="rightcontp">
                        <form onSubmit={createProduct}>
                            ...
                            <div className="rightcontinputs">
                                ...
                                <select id="country" value={country} onChange={(e) => setCountry(e.target.value)} name="country">
                            ...
                            <div className="rightconttitle">
                                <h2>Let’s Personalize Your Nutrition Plan!</h2>
                            </div>
                            ...
                            <div className="rightconttitle">
                                <h2>How much are you planning to invest in your health and nutrition?</h2>
                            </div>
                            <div className="rightcontredio">
                                {['Less than $80', '$80 - $150', '$150 - $200', 'More than $200'].map((priceRange) => (
                            ...
                            <div className="rightconttitle">
                                <h2>Tell Us About Your Health Goals</h2>
                            </div>
